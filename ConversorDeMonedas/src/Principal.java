...
public class Principal {
    public static void main(String[] args) {
        ...
        ConsultarMoneda consulta = new ConsultarMoneda(); // Llamamos a nuestra clase herramienta
        ...
        while (opcion != 9) {
            ...
            try {
                ...
                // Variables auxiliares para guardar los códigos de moneda
                String base = "";
                String target = "";

                // Configuramos las monedas según la opción
                switch (opcion) {
                    case 1:
                        base = "USD";
                        target = "ARS";
                ...
                // Limpiamos el scanner por si quedó basura en el buffer
                lectura.nextLine();
            }
        }
        lectura.close();
